...
@push('footer-script')
    <script type="text/javascript">
        ...
        $('#update-app').click(function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.easyAjax({
                        type: 'GET',
                        url: '{!! route("super-admin.updateVersion.update") !!}',
        ...
        function downloadWorksuite(){
            $.easyAjax({
                type: 'GET',
                url: '{!! route("super-admin.updateVersion.download") !!}',
                success: function (response) {
        ...
        function getDownloadPercent(){
            $.easyAjax({
                type: 'GET',
                url: '{!! route("super-admin.updateVersion.downloadPercent") !!}',
                success: function (response) {
        ...
        function installWorksuite(){
            $.easyAjax({
                type: 'GET',
                url: '{!! route("super-admin.updateVersion.install") !!}',
                success: function (response) {
                    $('#download-progress').append("<br><i><span class='text-success'>Installed successfully. Reload page to see the changes.</span>.</i>");
                    document.getElementById('logout-form').submit();
                }
