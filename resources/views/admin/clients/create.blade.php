                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company_name" name="company_name" value="{{ $leadDetail->company_name or '' }}" class="form-control" >
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address"  id="address"  rows="5" value="{{ $leadDetail->address or '' }}" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <!--/span-->
                                ...
                                <div class="row">
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name"  value="{{ $leadDetail->client_name or '' }}"   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" value="{{ $leadDetail->client_email or '' }}"  class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="mobile" id="mobile" value="{{ $leadDetail->mobile or '' }}" class="form-control">
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
