            ...
            @if($key % 2 == 0)
                <div class="row gap-y align-items-center">
                    <div class="col-12  col-md-5 text-center">
                        <img src="@if($value->image) {{ asset('front-uploads/feature/'.$value->image) }} @else {{ asset('front/img/demo/slack/tools.png') }} @endif" alt="...">
                    </div>
            ...
            @else
                <div class="row gap-y align-items-center">
                    ...
                    <div class="col-12 offset-md-1 col-md-5 text-center">
                        <img src="{{ asset('front-uploads/feature/'.$value->image) }}" alt="...">
                    </div>
                </div>
            @endif
