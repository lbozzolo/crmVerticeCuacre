                    ...
                    <div class="content-wrap">
                        <section id="section-line-1" class="show">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="white-box">
                                        <h3 class="b-b">@lang('app.project') #{{ $project->id }} - <span
                                                            ...
                                                            @forelse($project->members as $member)
                                                                ...
                                                                alt="user" class="img-circle" width="40" height="40">' !!}
                                                                    ...
                                                                    <div class="mail-contnet">
                                                                        <h5 class="m-t-10">{{ ucwords($member->user->name) }}</h5>
                                    ...
                                    <div class="row">
                                                            ...
                                                            <ul class="list-task list-group" data-role="tasklist">
                                                                ...
                                                                <li class="list-group-item" data-role="task">
                                                                    {{ ($key+1).'. '.ucfirst($task->heading) }} <label
                                                                            class="label label-success pull-right">{{ $task->due_date->format($global->date_format) }}</label>
                                                                </li>
                                                                @empty
                                                                    <li class="list-group-item" data-role="task">
                                        ...
                                        <div class="col-md-6">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-wrapper collapse in">
                                                    <div class="panel-body">
                                                        <ol class="list-task list-group" data-role="tasklist">
                                                            @forelse($recentFiles as $key=>$file)
                                                                <li class="list-group-item" data-role="task">
                                                                    {{ $file->filename }} <a target="_blank" href="{{ asset('user-uploads/project-files/'.$project->id.'/'.$file->hashname) }}" class="btn btn-info btn-circle"><i class="fa fa-search"></i></a>
                                                                </li>
                                                            @empty
                                                                <li class="list-group-item" data-role="task">
